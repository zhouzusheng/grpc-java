...
public final class NtlmEngine {
    ...
    /** Secure random com.aitek.data.generator.generator */
    ...
    private static byte[] makeRandomChallenge() throws NtlmEngineException {
        if (RND_GEN == null) {
            throw new NtlmEngineException("Random com.aitek.data.generator.generator not available");
        }
    ...
    static class Type3Message extends NTLMMessage {
        ...
        Type3Message(final String domain, final String host, final String user, final String password, final byte[] nonce,
            ...
            // Create a cipher com.aitek.data.generator.generator class.  Use domain BEFORE it gets modified!
