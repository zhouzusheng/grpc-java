...
public final class RouteLookupServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<RouteLookupRequest,
      RouteLookupResponse> getRouteLookupMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RouteLookup",
      requestType = RouteLookupRequest.class,
      responseType = RouteLookupResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<RouteLookupRequest,
      RouteLookupResponse> getRouteLookupMethod() {
    io.grpc.MethodDescriptor<RouteLookupRequest, RouteLookupResponse> getRouteLookupMethod;
      ...
      synchronized (RouteLookupServiceGrpc.class) {
        if ((getRouteLookupMethod = RouteLookupServiceGrpc.getRouteLookupMethod) == null) {
          RouteLookupServiceGrpc.getRouteLookupMethod = getRouteLookupMethod = 
              io.grpc.MethodDescriptor.<RouteLookupRequest, RouteLookupResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "grpc.lookup.v1.RouteLookupService", "RouteLookup"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  RouteLookupRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  RouteLookupResponse.getDefaultInstance()))
  ...
  public static RouteLookupServiceStub newStub(io.grpc.Channel channel) {
    return new RouteLookupServiceStub(channel);
  }
  ...
  public static RouteLookupServiceBlockingStub newBlockingStub(
    ...
    return new RouteLookupServiceBlockingStub(channel);
  }
  ...
  public static RouteLookupServiceFutureStub newFutureStub(
      io.grpc.Channel channel) {
    return new RouteLookupServiceFutureStub(channel);
  }
  ...
  public static abstract class RouteLookupServiceImplBase implements io.grpc.BindableService {
    ...
    public void routeLookup(RouteLookupRequest request,
                            io.grpc.stub.StreamObserver<RouteLookupResponse> responseObserver) {
  ...
  /**
   */
  public static final class RouteLookupServiceStub extends io.grpc.stub.AbstractStub<RouteLookupServiceStub> {
    private RouteLookupServiceStub(io.grpc.Channel channel) {
      super(channel);
    }
    ...
    @Override
    protected RouteLookupServiceStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  /**
   */
  public static final class RouteLookupServiceBlockingStub extends io.grpc.stub.AbstractStub<RouteLookupServiceBlockingStub> {
    private RouteLookupServiceBlockingStub(io.grpc.Channel channel) {
      super(channel);
    }
    ...
    @Override
    protected RouteLookupServiceBlockingStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  /**
   */
  public static final class RouteLookupServiceFutureStub extends io.grpc.stub.AbstractStub<RouteLookupServiceFutureStub> {
    private RouteLookupServiceFutureStub(io.grpc.Channel channel) {
      super(channel);
    }
    ...
    @Override
    protected RouteLookupServiceFutureStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<RouteLookupResponse> routeLookup(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ROUTE_LOOKUP:
          serviceImpl.routeLookup((RouteLookupRequest) request,
              (io.grpc.stub.StreamObserver<RouteLookupResponse>) responseObserver);
          break;
        default:
