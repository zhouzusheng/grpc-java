...
public class ConsulRawClient {
	...
	private static HttpTransport DEFAULT_HTTP_TRANSPORT = null;

	private final HttpTransport httpTransport;
	private final String agentAddress;

	public static void setDefaultHttpTransport(HttpTransport transport) {
		DEFAULT_HTTP_TRANSPORT = transport;
	}
	...
	public ConsulRawClient(HttpTransport transport) {
		this(DEFAULT_HOST, transport);
	}

	public ConsulRawClient(String agentHost, HttpTransport transport) {
		this(transport, agentHost, DEFAULT_PORT, DEFAULT_PATH);
	}

	public ConsulRawClient(String agentHost, int agentPort, HttpTransport transport) {
		this(transport, agentHost, agentPort, DEFAULT_PATH);
	}
